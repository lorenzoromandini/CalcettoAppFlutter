...
class _SignupScreenState extends ConsumerState<SignupScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<SignupFormState>(signupFormProvider, (prev, next) {
              ...
              children: [
                ...
                Image.asset(
                  ...
                  errorBuilder: (_, __, ___) =>
                      Icon(Icons.sports_soccer, size: 60, color: cs.primary),
                ),
                const SizedBox(height: 24),
                Text(
                  'Create Account',
                ...
                if (signupState.isSuccess) ...[
                  ...
                  TextFormField(
                    ...
                    onChanged: (v) =>
                        ref.read(signupFormProvider.notifier).setNickname(v),
                  ),
                  const SizedBox(height: 16),
                  TextFormField(
                    ...
                    validator: (v) => v == null || v.isEmpty
                        ...
                        : !v.contains('@')
                            ...
                            : null,
                    onChanged: (v) =>
                        ref.read(signupFormProvider.notifier).setEmail(v),
                  ),
                  const SizedBox(height: 16),
                  PasswordField(
                    ...
                    validator: (v) => v == null || v.isEmpty
                        ...
                        : v.length < 6
                            ...
                            : null,
                    onChanged: (v) =>
                        ref.read(signupFormProvider.notifier).setPassword(v),
                  ),
                  const SizedBox(height: 16),
                  PasswordField(
                    ...
                    validator: (v) =>
                        v != _passwordController.text ? 'No match' : null,
                    onFieldSubmitted: (_) {
