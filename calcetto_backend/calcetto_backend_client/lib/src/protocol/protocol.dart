...
import 'match.dart' as _i7;
import 'match_mode.dart' as _i8;
import 'match_participant.dart' as _i9;
import 'match_player_stats.dart' as _i10;
...
import 'package:calcetto_backend_client/src/protocol/match.dart' as _i16;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i7.Match) {
      return _i7.Match.fromJson(data) as T;
    }
    if (t == _i8.MatchMode) {
      return _i8.MatchMode.fromJson(data) as T;
    }
    if (t == _i9.MatchParticipant) {
      return _i9.MatchParticipant.fromJson(data) as T;
    }
    if (t == _i10.MatchPlayerStats) {
      return _i10.MatchPlayerStats.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i7.Match?>()) {
      return (data != null ? _i7.Match.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i8.MatchMode?>()) {
      return (data != null ? _i8.MatchMode.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i9.MatchParticipant?>()) {
      return (data != null ? _i9.MatchParticipant.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i10.MatchPlayerStats?>()) {
      return (data != null ? _i10.MatchPlayerStats.fromJson(data) : null) as T;
    }
    ...
    if (t == List<_i16.Match>) {
      return (data as List).map((e) => deserialize<_i16.Match>(e)).toList()
          as T;
    }
    if (t == List<_i17.MatchParticipant>) {
      return (data as List)
          .map((e) => deserialize<_i17.MatchParticipant>(e))
          .toList() as T;
    }
    if (t == List<_i18.PlayerRating>) {
      return (data as List)
          .map((e) => deserialize<_i18.PlayerRating>(e))
          .toList() as T;
    }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i7.Match) {
      return 'Match';
    }
    if (data is _i8.MatchMode) {
      return 'MatchMode';
    }
    if (data is _i9.MatchParticipant) {
      return 'MatchParticipant';
    }
    if (data is _i10.MatchPlayerStats) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Match') {
      return deserialize<_i7.Match>(data['data']);
    }
    if (dataClassName == 'MatchMode') {
      return deserialize<_i8.MatchMode>(data['data']);
    }
    if (dataClassName == 'MatchParticipant') {
      return deserialize<_i9.MatchParticipant>(data['data']);
    }
    if (dataClassName == 'MatchPlayerStats') {
      return deserialize<_i10.MatchPlayerStats>(data['data']);
    }
